        ...
        <div class="col-12 col-md-10 col-lg-10 col-xl-10  container-fluid">
            ...
            <section class="border p-2 my-3">
                ...
                <div id="portfolioPics" class=" pl-3">
                    <img src="images/yungFam.jpg" alt="A picture of my mom, sister, brother and I when we were young.">
                    <img src="images/halloween.jpg" alt="A picture in Seattle on a Halloween pub crawl with friends.">
                    <img src="images/meriNMe.jpg" alt="Meri and I.">
                    <img src="images/reach.jpg" alt="REACH camp counselors photo.">
                    <img src="images/wtfest.jpg" alt="WTFest with Nathan.">
                </div>
            </section>
            ...
            <section class="border p-2">
                ...
                <div class="d-inline-block portfolio mr-md-4">
                    <div class="portfolPrj">
                        <img src="images/groupPage.jpg" alt="A screenshot of the GRGG FAQ page.">
                ...
                <div class="d-inline-block portfolio">
                    <div class="portfolPrj">
                        <img src="images/javaAssignments.jpg" alt="A screenshot of a java assignment.">
                ...
                <div class="d-inline-block portfolio mr-md-4">
                    <div class="portfolPrj">
                        <img src="images/pizzaSite.jpg" alt="A screenshot of Poppa's Pizza site.">
                ...
                <div class="d-inline-block portfolio">
                    <div class="portfolPrj">
                        <img src="images/javaBlackJackprj.jpg"
                ...
                <div class="d-inline-block portfolio mr-md-4">
                    <div class="portfolPrj">
                        <img src="images/pythonYahtzee.jpg"
                ...
                <div class="d-inline-block portfolio">
                    <div class="portfolPrj">
                        <img src="images/liLearningBootstrap.jpg" alt="A certification for Bootstrap 4.">
